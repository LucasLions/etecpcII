...
public class App 
{
	...
	public static void main(String[] args) throws Exception{
		...
		UserSistemaDAO daolog = new UserSistemaDAO(conn);
		UserSistema userInsert = new UserSistema("Joao Lucas", "admin", "123");
		daolog.inserir(userInsert);
		
		
		//String sql = "insert into aluno(nmAluno) values ('alunos12')";
